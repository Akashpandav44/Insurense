...
public record ClaimRequestDto(String claimId, String claimName, String policyId, String customerId, String claimType, BigDecimal claimAmount, LocalDate incidentDate, LocalDateTime claimDate,
